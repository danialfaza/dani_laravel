...
<div class="section">
    <div class="card-panel purple darken-3 white-text"><center>Daftar kumpulan sinopsis Film</center></div>
</div>
...
<div class="section">
    ...
    <div class="row">
        <div class="col s12">
            ...
            <a href="{{ url('delete', $data->id) }}" onclick="return confirm('Yakin ingin menghapus data ini')" class="btn btn-flat red darken-4 waves-effect waves-light white-text">Delete <i class="material-icons right">delete</i></a>
        </div>
    </div>
    @endforeach
